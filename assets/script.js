(function () {
  ...
  function initQcm() {
    ...
    const modal = overlay ? overlay.querySelector('.qcm-modal') : null;
    ...
    if (!questions.length || !submitButton || !overlay || !modal || !modalLabel || !modalTitle || !modalText || !hintsWrap || !hintsList || !retryButton || !closeButton) {
      return;
    }
    ...
    function openOverlay(type, score, hints) {
      ...
      modal.classList.add(type === 'success' ? 'success' : 'failure');
